...
if($star == null){
    ...
    header("location:restaurant-detailed.php?chon=".$ma."");
}
else{
$kn = mysqli_connect("localhost","root","","tms") or die("Không kết nối được");
mysqli_query($kn,"SET NAMES 'utf8'");
$sql = " insert into comment_restaurant (cmt_id,id_user,title, cmt,star,gowith,month,year) VALUES ('". $_SESSION['id_res']."','". $_SESSION['id']."', '".$title_cmt."', '".$comment."', '".$star."', '".$gowith."', '".$month."', '".$year."')";
