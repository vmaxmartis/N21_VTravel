...
<!-- =======================
  ...
  <?php
   ...
   $lldl= "select * from hotel where id='".$ma."' ";
...
<div class ="khoangcach"></div>
  ...
  <h1>Khám phá <span class="text-primary" ><?php echo $row_ct['title'] ?></span>  <span class="text-secondary">Cùng với VTravel.</span></h1>
          ...
          <div class="tab-pane booking-search show active" id="tab-de-1">
            ...
            <h5 class="text-primary" > <?php echo $row_ct['title'] ?> <span class="text-danger"> <?php echo $row_ct['rank'] ?> </span>  <span class="text-secondary"> SAO </span> </h5>  
            <div class="text-block NopaddingDetails">
    ...
    <div class="row">
      ...
      <div class="content">
        <div class="tab-content">
          ...
          <div class="col-18">
              ...
              <div class="swiper-container guides-slider">
                    <div class="swiper-wrapper imgdeta2"> 
                      ...
                      <div class="swiper-slide h-auto px-2">
                        <div class="card card-poster"><a  class="tile-link"></a><img style=" height:150px;" src="bdesign/images/img_source/<?php echo $row_ct['iva1'] ?>" alt="Card image" class="bg-image">                         
                        </div>
                      </div>
                      <div class="swiper-slide h-auto px-2">
                        <div class="card card-poster"><a  class="tile-link"></a><img style=" height:150px;" src="bdesign/images/img_source/<?php echo $row_ct['iva2'] ?>" alt="Card image" class="bg-image">                         
                        </div>
                      </div>
                      <div class="swiper-slide h-auto px-2">
                        <div class="card card-poster"><a  class="tile-link"></a><img style=" height:150px;" src="bdesign/images/img_source/<?php echo $row_ct['iva3'] ?>" alt="Card image" class="bg-image">                         
                        </div>
                      </div>
                      <div class="swiper-slide h-auto px-2">
                        <div class="card card-poster"><a  class="tile-link"></a><img style=" height:150px;" src="bdesign/images/img_source/<?php echo $row_ct['iva4'] ?>" alt="Card image" class="bg-image">                         
                        </div>
                      </div>
                    </div>
            </div>
            ...
            <div class="text-block">
              <p class="subtitle text-sm text-primary">Khách sạn </p>
              <h5 class="mb-4">Đánh giá </h5>
              <?php
              //lấy dữ liệu cmt
                $id_hotel = $row_ct['id'];
             ...
             $kn3 = mysqli_connect("localhost","root","","tms") or die("Không kết nối được");
              ...
              $lldl3= "select * from comment_hotel";
              ...
              ?>
             <?php 
                $lpt3="select * from comment_hotel where cmt_id='".$id_hotel."' limit {$vtbd3},{$sodong3}";
            ...
            <div class="col-md-12">
                <div id="leaveReview" class="mt-4 collapse show" style="">
                  ...
                  <form id="contact-form" method="get" action="xulycmt_hotel.php" class="form" name="v1">
                    <div class="row cmtct">
                       ...
                       <label class="star star-4" for="star-4"></label>
                        ...
                        <label class="star star-2" for="star-2"></label>
                         <input class="star star-1" id="star-1" type="radio" name="star" value="1"/>
                          ...
                          <input class="form-control" type="text" name="title_cmt"  placeholder="Tiêu đề ngắn gọn" required class="form-control"autocomplete="off" maxlength="50">
                          <br><label >Nội dung </label><br>
                          <textarea class="form-control text_cmt2" rows="5" cols="70"  name="comment" placeholder="Chi tiết mô tả của bạn" required class="form-control"autocomplete="off" maxlength="350"></textarea>
                          <hr class="text-sm hr_cmt0" width="30%"  />
                          <label >Bạn đi cùng ai</label><br>
                          <select class="form-control" name ="gowith">
                          ...
                          <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="inputGroupFile01">Tải ảnh lên (Nếu có)</label>
                          </div>
                        </div>
      ...
      <div  class="col-lg-4 col-md-12 col-sm-12 right_Details">
        <div class="p-4 shadow ml-lg-4 rounded sticky-top" style="top: 100px;">
          ...
          <?php
                  $query14 = mysqli_query($kn3, 'SELECT AVG(star) FROM `comment_hotel` WHERE `cmt_id` = "'. $_GET['chon'].'"');
                  if ($row14 = mysqli_fetch_array($query14)) {
                      $averageratestar =round($row14[0], 1);
                      echo '<a action="v1"  class="btn btn-outline-warning text-success"> Điểm đánh giá người dùng  '.$averageratestar.' <i class="fa fa-star "></i>  </a>';
                      
                  } 
          ?><br>
          Giá chỉ từ <a class="text-secondary"> <?php echo $row_ct['pricemin'] ?> đ </a> <a class="Text transform" style="textsize: 18px;">Phòng đơn</a></li> </i>             
                  <br> Giá chỉ từ <a class="text-secondary"> <?php echo $row_ct['pricemax'] ?> đ </a> <a class="Text transform" style="textsize: 18px;">Phòng đôi</a></li> </i>    <br><br>  
          <hr class="my-4">
          <div class ="chinout">
          <a  class="btn btn-outline-success">Checkin <br> <?php echo $row_ct['checkin'] ?> </a><a  class="btn btn-outline-white">-</a><a  class="btn btn-outline-danger">checkout <br> <?php echo $row_ct['checkout'] ?> </a>  
          </div>
          <hr class="my-4">
              <!-- Listing Location-->
...
<section class="Categories pt80 pb60 hotelsamilar">
  <div class="container">
    <div class="row mb-5">
      <div class="col-md-8">
        <p class="subtitle text-secondary nopadding">Khách sạn</p>
        <h1 class="paddtop1 font-weight lspace-sm">Có thể bạn thích </h1>
      </div>
      <div class="col-md-4 d-lg-flex align-items-center justify-content-end"><a href='hotel.php?chon=<?php echo $row_pro['id'] ?>' class="blist text-sm ml-2"> Xem tất cả<i class="fas fa-angle-double-right ml-2"></i></a></div>
    </div>
    <div class="row">
      <div class="swiper-container guides-slider-popular"> 
        ...
        <div class="swiper-wrapper"> 
          ...
          <?php
           ...
           ?>
           <?php 
            $lpt2="select * from hotel limit {$vtbd2},{$sodong2}";
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 swiper-slide">
            <div class="listroBox">
              <figure> <a " class="wishlist_bt"></a><a href='hotel-detailed.php?chon=<?php echo $row_pro['id'] ?>'><img src="bdesign/images/img_source/<?php echo $row_pro['iva1'] ?>" class="img-fluid" alt="" >
                <div class="read_more"><span>Xem thêm</span></div>
                </a> </figure>
              <div class="listroBoxmain">
                <h3><a "><?php echo $row_pro['title'] ?> <p class="R_retings">
                  <?php
                        $query14 = mysqli_query($kn, 'SELECT AVG(star) FROM `comment_hotel` WHERE `cmt_id` = "'. $machon2.'"');
                        if ($row14 = mysqli_fetch_array($query14)) {
                            $averageratestar =round($row14[0], 1);
