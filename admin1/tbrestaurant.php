...
<body class="fixed-navbar">
    ...
    <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Danh sách Nhà Hàng</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="index.html"><i class="la la-home font-20"></i></a>
                    </li>
                    <li class="breadcrumb-item">Nhà Hàng Việt Nam</li>
                </ol>
            </div>
            ...
            <div class="ibox">
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td> 
                                    <a href="updaterestaurant.php?id=<?php echo $row_pro['id'] ?>" class="text-success">Sửa</a>
                                        <a href="deleterestaurant.php?id=<?php echo $row_pro['id'] ?>" style=" margin-left: 20px;" onclick="abc()" class="text-warning">Xóa</a>
                                         <script>
                                              function abc(){
                    ...
                    ?>
                        ...
                        {
                            echo "<a href='tbrestaurant.php?trang=$i'>Trang $i></a>";
                        }
                        ?>
                    </div>
                </div>
            ...
            <div class="ibox">
                    ...
                    <div class="ibox-body">
                        ...
                        $kn = mysqli_connect("localhost","root","","tms") or die("Không kết nối được");
                        mysqli_query($kn,"SET NAMES 'utf8'");
                        $lldl= "select * from comment_restaurant";
                        $kqdl=mysqli_query($kn,$lldl);
                        $sodongdl=mysqli_num_rows($kqdl);
                        $sotrangdl=$sodongdl/$sodong;
                        $vtbd=$page*$sodong;
                        ?>
                        <?php 
                        $lpt="select * from comment_restaurant limit {$vtbd},{$sodong}";
                        $kqpt=mysqli_query($kn,$lpt);
                        ?>
                        <?php 
                        while ($row_pro=mysqli_fetch_array($kqpt)){
