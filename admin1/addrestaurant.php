...
<?php
    if(isset($_POST['them'])){
        ...
        $rate = $_POST['rate'];
        $map = $_POST['map'];
        if($conn -> query("INSERT INTO `restaurant`( `city`, `type`, `title`, `iva1`, `iva2`, `iva3`, `iva4`, `iva5`, `content`, `shortcontent`, `open`, `close`, `pricemax`, `pricemin`, `address`, `nborate`, `rate`, `map`) VALUES ('$city','$type','$title','$iva1','$iva2','$iva3','$iva4','$iva5','$shortcontent','$content','$open','$close','$pricemax','$pricemin','$address','$nborate','$rate','$map')")){
        }
                        ...
                        <div class="ibox">
                            ...
                            <div class="ibox-body" style="">
                                <form method="POST" action="#">
                                    ...
                                    <script>
                                              function abc(){
                                              if(alert("Thêm nhà hàng thành công!") == true){
                                              }
                                           }
                                    </script>
                                    </div>
