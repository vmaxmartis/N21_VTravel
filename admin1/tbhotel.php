                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td> <a href="updatehotel.php?id=<?php echo $row_pro['id'] ?>" class="text-success">Sửa</a>
                                        <a href="deletehotel.php?id=<?php echo $row_pro['id'] ?>" style=" margin-left: 20px;" onclick="abc()" class="text-warning">Xóa</a>
                                         <script>
                                              function abc(){
