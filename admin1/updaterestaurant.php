...
<?php
    if(isset($_POST['update'])){
        ...
        $rate = $_POST['rate'];
        $map = $_POST['map'];
        if($conn -> query("UPDATE restaurant SET `city`='$city',  `type`='$type', `title`='$title' ,`content`='$content', `shortcontent`='$shortcontent', `open`='$open', `close`='$close', `pricemax`='$pricemax', `pricemin`='$pricemin', `address`='$address', `nborate`='$nborate', `rate`='$rate', `map`='$map' WHERE id='$idupdate' ")){
        }
...
?>
<?php $sql="select * from restaurant where id = $id";
...
<?php include("./form.php") ?>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Cập nhật một nhà hàng </h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="index.html"><i class="la la-home font-20"></i></a>
                    </li>
                    <li class="breadcrumb-item">Cập nhật một nhà hàng </li>
                </ol>
            </div>
                            ...
                            <div class="ibox-body" style="">
                                <form method="POST" action="#">
                                    ...
                                    <div class="col-sm-3 form-group">
                                        ...
                                        <div class="col-sm-3 form-group">
                                            <label>Vùng</label>
                                            <input class="form-control" type="text" value="<?php echo $rows['type'] ?>" placeholder="Vùng" name="type">
                                        </div>
                                        <div class="col-sm-3 form-group">
                                            <label>Tiêu đề</label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3 form-group">
                                            <label>open </label>
                                            <input class="form-control" type="text" value="<?php echo $rows['open'] ?>" placeholder="14h00" name="open">
                                        </div>
                                        <div class="col-sm-3 form-group">
                                            <label>close</label>
                                            <input class="form-control" type="text" value="<?php echo $rows['close'] ?>" placeholder="23h00" name="close">
                                        </div>
                                        <div class="col-sm-3 form-group">
                                    ...
                                    <script>
                                              function abc(){
                                              if(alert("Cập nhật nhà hàng thành công!") == true){
                                              }
                                           }
                                    </script>
